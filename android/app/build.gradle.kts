...
android {
    ...
    // رُفع من 36 إلى 37 لأن receive_sharing_intent (المُضافة لدعم Share/Open
    // With — قسم 3-7) تتطلب compileSdk 37+ فعليًا (فشل :app:checkReleaseAarMetadata
    // بهذا بالضبط عند 36). حدّث MIN_COMPILE_SDK في tool/patch_compile_sdk.py
    // بالتوازي مع أي رفع مستقبلي لهذا الرقم.
    compileSdk = 37
